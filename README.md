...
| 按键 | 输出内容 | 使用场景 |
|:----:|:---------|:---------|
| **F7** | `停` | Interrupt：Agent 胡说八道，优雅打断 |
| **F8** | `简洁点` | Steer：Agent 话太多，让它精简 |
| **F9** | `换个思路` | Steer：Agent 走偏了，换方向 |
| **F10** | `先验证` | Steer：让 Agent 先跑测试再改代码 |
| **F11** | `注释写清楚` | Steer：代码写完了，补好注释 |
...
| **F7** / Ctrl+Shift+7 | `停` ↵ |
| **F8** / Ctrl+Shift+8 | `简洁点` ↵ |
| **F9** / Ctrl+Shift+9 | `换个思路` ↵ |
| **F10** / Ctrl+Shift+0 | `先验证` ↵ |
| **F11** | `注释写清楚` ↵ |
| **F12** | 暂停/恢复 |
| **Ctrl+C** | 退出 |
